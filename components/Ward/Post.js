                   ...
                   <Link href={`/userProfile/${uid}`}>
                     ...
                     />
                       ...
                       <div className="flex-1">
                         ...
                         {post?.data()?.citeInput ? (
                           <div>
                         <p onClick={() => router.push(`/wardposts(id)/${id}`)} className="text-[20px] sm:text-[16px]">{post?.data()?.citeInput}</p>
                       ...
                       <Badge className="py-0" color="gray" icon={HiClock}>
                         ...
                         <p className="ml-14 text-[20px] sm:text-[16px]" onClick={() => router.push(`/wardposts(id)/${id}`)}>{post?.data()?.text}</p>

    ...
    <div className="flex p-3 cursor-pointer pl-20">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* dot icon */}
          <DotsHorizontalIcon className="h-10 w-10 hover:bg-sky-100 hover:text-sky-500 p-2 rounded-full dark:hover:bg-neutral-700" />
        </div>
        ...
        <div className="flex justify-between text-gray-300 p-2">
          ...
          <Tooltip content='delete' arrow={false} placement="bottom" className="p-1 text-xs bg-gray-500 -mt-1">
            <TrashIcon
              ...
              className="h-9 w-9 p-2 hover:text-red-600 hover:bg-red-100 rounded-full dark:hover:bg-neutral-700"
            />
          </Tooltip>
          )}
          ...
          <ReplyIcon className="h-9 w-9 p-2 hover:text-sky-500 hover:bg-sky-100 rounded-full dark:hover:bg-neutral-700" />
        </Tooltip>
        </div>
      </div>
    </div>

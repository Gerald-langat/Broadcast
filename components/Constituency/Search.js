...
function SearchComponent({ post }) {
  ...
  return (
    <div>
      {post && (
        <div className="flex cursor-pointer items-center dark:hover:bg-neutral-700 hover:bg-slate-100 w-full" onClick={() =>  router.replace(`/constituencyposts/${ post.data().name}`)}>

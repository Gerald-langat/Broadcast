...
export default function Widgets() {
  ...
  return (
    <div className=" dark:bg-gray-950 bg-white w-[800px] xl:inline h-full  space-y-5">
      {loading ? (
        ...
        <>
        <div className=" dark:bg-gray-950 sticky -mt-2 w-full ml-4 h-full">
          <div className='flex xl:ml-1 ml-24 dark:bg-gray-950 bg-gray-200 items-center dark:border-gray-900 xl:w-[335px] sm:w-[88%] w-[383px] border-b-[1px] rounded-md top-2 fixed '>
            <SearchIcon className='h-8 sm:h-6 text-gray-500 z-40 dark:text-gray-300 '/>
          <input
            className="border-0 dark:bg-gray-950 bg-gray-200 w-full text-lg 
          ...
          />
          <div className={`p-1 bg-sky-500 sm:mr-6 rounded-full cursor-pointer hover:bg-sky-400 ${!querySearch ? 'hidden' : 'inline'}`}>
      ...
      <div>
      <div className='dark:bg-gray-950 bg-white space-x-2 mt-2 top-12 fixed z-30 xl:ml-1 ml-24 p-2 w-full rounded-t-md'>
      ...
      <br></br>
      <div className="dark:bg-gray-950 xl:ml-1 ml-24 text-gray-700  bg-slate-50 rounded-xl pt-2 mt-20
       fixed w-[90%] xl:w-[75%] h-full">
      ...
      {loading ? (
            ...
            <div>
            <div className="items-center justify-center -space-y-6 -mt-2 ">

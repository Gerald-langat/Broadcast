    ...
    <div className='absolute  sm:ml-[394px] top-2  ml-[300px] md:ml-[420px] lg:ml-[412px]  md:mt-6 flex items-center'>
        ...
        <BackgroundCircles />
         ...
         {selectedCategory && (
          ...
          {isOpen && (
            <div className='absolute mt-2  md:w-56 w-[300px] z-40 rounded-md shadow-lg bg-gray-200 ring-1 ring-black ring-opacity-5 dark:bg-gray-900'>
              <div className='py-1' role='menu' aria-orientation='vertical' aria-labelledby='options-menu'>
                {counties.map(county => (
                  <button
                    key={county.countyCode}
                    className='block px-4 py-2 text-xl w-full z-60 md:text-sm dark:bg-gray-900 dark:text-gray-50 bg-gray-200 hover:bg-slate-100 text-gray-800  text-left dark:hover:bg-gray-950'
                    onClick={() => {

...
export default function TopicPostsPage() {
  ...
  <main className="flex flex-1 min-h-screen sm:min-w-[768px] xl:max-w-7xl mx-auto mb-12">
    ...
    {/* Feed */}
    <div className="flex-col  sm:min-w-[600px] sm:mx-auto">
      <div className="flex items-center space-x-2 py-3  px-4 sticky top-0 bg-white dark:bg-gray-950 border-b dark:border-gray-800 border-gray-200">

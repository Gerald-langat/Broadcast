...
useEffect(
  () =>{
    ...
    onSnapshot(
      query(collection(db, "constituency", userData.constituency, id, "comments")),
      (snapshot) => {
    ...
    <div>
     ...
     border-gray-200  xl:min-w-[576px]  sm:min-w-full flex-grow max-w-xl">
      ...
      <div className='xl:hidden justify-between bottom-0 z-40 fixed bg-slate-50
       dark:bg-neutral-700 w-[500px] sm:w-screen min-w-[476px] flex p-2  sm:px-10 md:px-24 px-4 flex-grow'>
